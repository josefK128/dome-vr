...
export const Pointaudio = class {
    static create(options = {}, narrative) {
        ...
        return new Promise((resolve, reject) => {
            ...
            maxd = options['maxd'] || 1000., playbackRate = options['playbackRate'] || 1.0, volume = options['volume'] || 1.0, delay = options['delay'], loop = options['loop'] || false, play = false, pause = false, stop = true, audioLoader = new THREE.AudioLoader(), sound = new THREE.PositionalAudio(narrative['audioListener']), actor = narrative.findActor(actorname);
            ...
            sound['startAudio'] = () => {
                ...
                audioLoader.load(url, (buffer) => {
                    ...
                    if (delay) {
                        ...
                        const delay_ = ctx.createDelay();
                        delay_.delayTime.value = delay;
                        console.log(`sound = ${sound}:`);
                        console.dir(sound);
                        console.log(`delay_ = ${delay_}:`);
                        console.dir(delay_);
                        sound.connect(delay_);
...
//# sourceMappingURL=pointaudio-delay.js.map