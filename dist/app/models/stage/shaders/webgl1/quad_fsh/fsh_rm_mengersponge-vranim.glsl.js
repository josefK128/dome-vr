// fsh_mengersponge-vranim.glsl.ts
// fragment shader
// raymarch - expt3-infinite mengersponge - adapted from Roast
import * as THREE from '../../../../../../../node_modules/three/build/three.module.js';
const uniforms = {
    tDiffuse: { type: 't', value: null },
    uVertex: { type: 'v3', value: new THREE.Vector3(0, 0, 1) },
...
//animation => eye = cameraPos + animation
vec3 animation= vec3(0.0,0.0,0.0);
...
vec4 colormarch(vec3 ro, vec3 rd) {
   ...
   return vec4(0.0,0.0,0.0,1.0);
     ...
     void main() {
       ...
       //EXPT *****************************
       //FAILS with cantor3D! - works in other rm-shaders
       //eye.z = eye.z + 0.75*sin(uTime/10.);
       //EXPT *****************************
...
export { fsh, uniforms };
//# sourceMappingURL=fsh_rm_mengersponge-vranim.glsl.js.map