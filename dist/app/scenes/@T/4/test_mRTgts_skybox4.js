// scenes/@T/4/test_mRTgts_skybox4.ts 
    ...
    camera: {
        vr: {
            ...
            controls: {
                ...
                //NOTE: if animating an actor, use 'vrscene'!!!
                _controls: true,
                controls_speed: 0.1,
                _keymap: 'vr',
    ...
    stage: {
        ...
        vrscene: {
            ...
            actors: {
                ...
                'vrskybox': {
                    factory: 'Skybox',
                    url: '../models/stage/actors/mrtgts/mrtgts_skybox.js',
                    options: {
                        size: 10000,
                        color: 'orange',
                        opacity: 1.0,
...
//# sourceMappingURL=test_mRTgts_skybox4.js.map