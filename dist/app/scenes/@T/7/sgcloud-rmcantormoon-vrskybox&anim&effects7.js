// @/@T/7/sgcloud-rmcantormoon-vrskybox&anin&effects7.ts
...
const config = {
    ...
    topology: {
        ...
        _sgeffect: true,
        //sgeffects?:object[];
        //particular effects added to chain of 'passes'
        //possible key-values:
        //'dotscreen','afterimage','bloom','halftone','film'
        //values for keys are ctor-param arrays w. lengths:
        //dotscreen(0),halftone(0),afterimage(1),bloom(3),film(4).
        //display result is order-dependent.
        //it is advisable to keep the sequence brief and focused.
        //see docs for ctor-param names, defaults - signatures are:
        //DotScreen(center,angle,scale - defaults=0)  => []
        //HalfTone(w.innerW,h.innerH,params-default)  => []
        //AfterImage(damp=.96) 0=>no trails, 1.0=>continuous => [.96]
        //Bloom(strength=1, kernelSize=25, sigma=4) => [1,25,4]
        //Film(noiseIntensity,scanlinesIntensity,scanlinesCount,grayscale)
        //subtle => new FilmPass(.35, .025, 648, false) => [.35,.025,648,f]
        //exp: sgeffects:{dotscreen:[], film:[.35,.025,648,false]}
        //NOTE! effects are order-dependent so array is used
        sgeffects: [{ 'bloom': [1, 25, 4] }, { 'afterimage': [.96] }],
        ...
        //Film(noiseIntensity,scanlinesIntensity,scanlinesCount,grayscale)
        //subtle => new FilmPass(.35, .025, 648, false) => [.35,.025,648,f] 
        //exp: rmeffects:{dotscreen:[], film:[.35,.025,648,false]}
        //NOTE! effects are order-dependent so array (object[]) is used
        rmeffects: [{ 'halftone': [] }, { 'film': [4.35, 2.025, 136, false] }],
        //rmeffects:[{'film':[5.35, 2.025, 36, true]}],
        //rmeffects:[{'halftone':[]}],
...
//# sourceMappingURL=sgcloud-rmcantormoon-vrskybox&anim&effects7.js.map